...
export default function Orders() {
    ...
    const openOderForm = useCallback(
        (data) =>
            dispatch({type: 'OPEN_DRAWER', drawerComponent: 'OPEN_ORDER_EDIT_FORM', data: data}),
                    ...
                    <Wrapper style={{boxShadow: '0 0 5px rgba(0, 0 , 0, 0.05)'}}>
                        <TableWrapper>
                            <StyledTable
                                ...
                                <StyledHeadCell>O:Id</StyledHeadCell>
                                <StyledHeadCell>C:Id</StyledHeadCell>
                                        ...
                                        data.orders
                                            .map((item, index) => (
                                                <React.Fragment key={index}>
                                                    ...
                                                    <StyledCell><AiTwotoneEdit/></StyledCell>
                                                    <StyledCell>
                                                        <div onClick={()=>openOderForm(item)}
                                                             style={{cursor: 'pointer'}}><AiTwotoneEdit/>
                                                        </div>
                                                    </StyledCell>
                                                </React.Fragment>
                                            ))
