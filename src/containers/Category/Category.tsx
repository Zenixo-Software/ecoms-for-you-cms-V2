...
export default function Category() {
  ...
  const openCategoryForm = useCallback(
    (data) =>
      drawerDispatch({
        type: "OPEN_DRAWER",
        drawerComponent: "OPEN_CATEGORY_EDIT_FORM",
        data: data,
      }),
    [drawerDispatch]
  );
      ...
      <Row>
        <Col md={12}>
          ...
          <Wrapper style={{ boxShadow: "0 0 5px rgba(0, 0 , 0, 0.05)" }}>
            <TableWrapper>
              <StyledTable $gridTemplateColumns="minmax(100px, auto) minmax(100px, auto) minmax(100px, auto) minmax(100px, auto) minmax(100px, auto) minmax(100px, auto)">
                      ...
                      <React.Fragment key={index}>
                        ...
                        <StyledCell>
                          <ImBoxRemove
                            onClick={() =>
                              dispatch({
                                type: categoryAction.CATEGORY_REMOVE_MODEL_OPEN,
                              })
                            }
                            style={{ cursor: "pointer" }}
                          />
